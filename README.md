...
4. Настройте интеграции, тарифы, триал, сквады, контент и функции. Новый стеклянный интерфейс включается в разделе **Админка → Дизайн → Glass**; Classic остаётся доступен там же. Язык и шрифт можно повторно выбрать в разделе **Админка → Язык и шрифт**.
