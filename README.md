...
4. Настройте интеграции, тарифы, триал, сквады, контент и функции. Самостоятельный минималистичный интерфейс с боковой навигацией на широком экране и компактным нижним меню на телефоне включается в разделе **Админка → Дизайн → Новый интерфейс**; классический вариант остаётся доступен там же. Язык и шрифт можно повторно выбрать в разделе **Админка → Язык и шрифт**.
