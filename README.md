...
Скрипт без лишнего лога покажет версию, список изменённых файлов, компактный прогресс Docker и состояние сервисов. Обновление сохраняет базу данных и настройки из админки. Уже созданные тарифы, оформление и интеграции не сбрасываются на новые значения по умолчанию.
