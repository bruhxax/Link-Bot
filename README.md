...
4. Настройте интеграции, тарифы, триал, сквады, контент и функции. Самостоятельный интерфейс с боковым меню, новой компоновкой экранов и анимированным переключением включается в разделе **Админка → Дизайн → Новый / Glass**; Classic остаётся доступен там же. Язык и шрифт можно повторно выбрать в разделе **Админка → Язык и шрифт**.
